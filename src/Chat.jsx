...
export default function Chat() {
  ...
  function connectToWs() {
    ...
    const room = [id, selectedUserId].sort().join("__");
    const socket = new WebSocket(import.meta.env.VITE_WS_BASE_URL + room + "/");
  ...
  function handleMessage(ev) {
    ...
    console.log("WS incoming:", messageData);

    if (!messageData.message && !messageData.file) return;
        ...
        <div className="flex-grow">
          ...
          {Object.keys(offlinePeople).map(userId => (
            <Contact
              ...
              onClick={() => {setSelectedUserId(userId);console.log(offlinePeople[userId])}}
              selected={userId === selectedUserId} />
          ))}
        </div>
